package com.java.dolmayan.JavaStreamsApi.ApiFundamentals.model;
...
public class StudentDataBase {
    ...
    public static List<Student> getAllStudents(){
         ...
         * 3rd grade students
         */
        Student student3 = new Student("Edwin",3,4.0,"female", 12,Arrays.asList("swimming", "gymnastics","aerobics"));
        ...
        Student student7 = new Student("James",1,3.9,"male", 22,Arrays.asList("gymnastics", "basketball","baseball","football"));
